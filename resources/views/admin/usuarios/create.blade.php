...
@section('content')
<div class="max-w-lg">
    <form action="{{ route('admin.usuarios.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded-xl border border-slate-200">
        @csrf
        <div>
            <label for="documento" class="block text-sm font-medium text-slate-700">Documento</label>
            <input type="text" name="documento" id="documento" value="{{ old('documento') }}" required class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500">
        ...
        <div>
            ...
            <input type="text" name="nombres" id="nombres" value="{{ old('nombres') }}" required class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500">
        ...
        <div>
            <label for="password" class="block text-sm font-medium text-slate-700">Contraseña (opcional)</label>
        ...
        <div>
            <label for="codigo_qr" class="block text-sm font-medium text-slate-700">Código QR (opcional)</label>
            <input type="text" name="codigo_qr" id="codigo_qr" value="{{ old('codigo_qr') }}" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-slate-500 focus:ring-slate-500">
