...
@section('page-title', 'Nuevo tipo de usuario')

@section('content')
<div class="max-w-lg">
    <form action="{{ route('admin.tipos-usuario.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded-xl border border-slate-200">
        @csrf
        <div>
