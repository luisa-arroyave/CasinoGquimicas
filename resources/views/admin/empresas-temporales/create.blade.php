...
@section('title', 'Nueva empresa temporal')
@section('page-title', 'Nueva empresa temporal')

@section('content')
<div class="max-w-lg">
    <form action="{{ route('admin.empresas-temporales.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded-xl border border-slate-200">
        @csrf
        <div>
