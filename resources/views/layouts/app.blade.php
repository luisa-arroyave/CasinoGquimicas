            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
                    ...
                    <div class="space-y-0.5">
                        ...
                        <a href="{{ route('admin.empresas-contratistas.index') }}" class="flex items-center gap-3 pl-4 pr-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition-colors {{ request()->routeIs('admin.empresas-contratistas.*') ? 'bg-slate-800 text-white' : '' }}">Empresa contratista</a>
